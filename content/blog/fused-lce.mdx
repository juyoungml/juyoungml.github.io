...
date: 2026-05-05
description: Why fusing the LM head projection with cross-entropy is the single biggest memory win for training LLMs at long context.
tags:
  - training
  - kernels
  - memory
...
<Video src="/videos/fused-lce-overview.mp4" caption="The baseline path keeps the full N × V logits tensor resident; the fused path slides a C × V chunk through SRAM. Rendered with Manim." number={1} />
