export const portfolioData = {
  ...
  personal: {
    ...
    emailUser: 'juyoung.suk',
    emailDomain: 'trillionlabs.co',
  ...
  experience: [
    {
      ...
      highlights: ['Trained Tri-7B, Tri-21B, and Tri-70B models'],
    },
    {
      id: 2,
      ...
      highlights: ['End-to-end ML pipeline for Metabuddy application'],
    },
    {
      id: 3,
      ...
      highlights: ['40+ million user production model'],
    },
  ],
  ...
  publications: [
    {
      ...
      links: {
        paper:
          'https://scholar.google.com/citations?view_op=view_citation&hl=en&user=mENsLCkAAAAJ&citation_for_view=mENsLCkAAAAJ:u-x6o8ySG0sC',
    ...
    },
    {
      ...
      links: {
        paper:
          'https://scholar.google.com/citations?view_op=view_citation&hl=en&user=mENsLCkAAAAJ&citation_for_view=mENsLCkAAAAJ:u5HHmVD_uO8C',
    ...
    },
    {
      ...
      links: {
        paper:
          'https://scholar.google.com/citations?view_op=view_citation&hl=en&user=mENsLCkAAAAJ&citation_for_view=mENsLCkAAAAJ:d1gkVwhDpl0C',
    ...
    },
    {
      ...
      authors:
        'S Kim, J Suk, X Yue, V Viswanathan, S Lee, Y Wang, K Gashteovski, ...',
      venue: 'ACL',
      year: 2025,
      abstract:
      ...
      links: {
        paper:
          'https://scholar.google.com/citations?view_op=view_citation&hl=en&user=mENsLCkAAAAJ&citation_for_view=mENsLCkAAAAJ:2osOgNQ5qMEC',
    ...
    },
    {
      ...
      links: {
        paper:
          'https://scholar.google.com/citations?view_op=view_citation&hl=en&user=mENsLCkAAAAJ&citation_for_view=mENsLCkAAAAJ:UeHWp8X0CEIC',
    ...
    },
    {
      ...
      links: {
        paper:
          'https://scholar.google.com/citations?view_op=view_citation&hl=en&user=mENsLCkAAAAJ&citation_for_view=mENsLCkAAAAJ:9yKSN-GCB0IC',
    ...
    },
    {
      ...
      links: {
        paper:
          'https://scholar.google.com/citations?view_op=view_citation&hl=en&user=mENsLCkAAAAJ&citation_for_view=mENsLCkAAAAJ:qjMakFHDy7sC',
  ...
  news: [
    {
      ...
      date: '2025-08',
      content:
        'We released Tri-7B, Tri-21B, and Tri-70B models! Come check out our models on HuggingFace!',
    ...
    },
    {
      ...
      date: '2025-06',
      content:
        'Glad to share that The BiGGen Bench has won the best paper award in NAACL 2025!',
    ...
    },
    {
      ...
      date: '2025-03',
      content:
        'We released Trillion-7B Technical Whitepaper detailing our compute-efficient multilingual frontier model.',
    ...
    },
    {
      ...
      date: '2024-11',
      content:
        'Started position as Member of Technical Staff at Trillion Labs, working on next-generation multilingual language models.',
    },
  ],
