...
const About: NextPage = () => {
  const { personal, about, experience, projects, publications, news } = portfolioData

  return (
    <>
      <Head>
        <title>About - {personal.name}</title>
        <meta name="description" content={`About ${personal.name} - M.S. Student in AI at KAIST. Research in language model evaluation, multilingual AI systems, and deep learning architectures.`} />
        ...
        <meta property="og:title" content={`About - ${personal.name}`} />
        ...
        <meta property="og:url" content="https://juyoungml.github.io/about" />
        <meta property="og:image" content="https://juyoungml.github.io/profile.jpeg" />
        
        {/* Twitter Card Meta Tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`About - ${personal.name}`} />
      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="max-width-container section-padding py-16">
          ...
          {/* Contact Section - Relocated to top */}
          <ContactSection
            email={personal.email}
